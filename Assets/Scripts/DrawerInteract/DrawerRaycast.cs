...
namespace DrawerSystem
{
    public class DrawerRaycast : MonoBehaviour
    {
        ...
        private DrawerItemController raycastedObject;
        ...
        private string interactableTag = "DrawerObject";
        ...
        private void Update()
        {
            ...
            if (Physics.Raycast(transform.position, fwd, out hit, rayLength, mask))
            {
                if (hit.collider.CompareTag(interactableTag))
                {
                    ...
                    if (!doOnce)
                    {
                        raycastedObject = hit.collider.gameObject.GetComponent<DrawerItemController>();
